...
export const Sidebar: React.FC = () => {
  ...
  const navItems = [
    ...
    { label: 'Appointments', path: '/appointments', icon: Calendar, roles: ['owner', 'admin', 'operation_manager', 'ccd', 'psychologist'] },
    { label: 'Documents & Consent', path: '/documents', icon: Folder, roles: ['owner', 'admin', 'operation_manager', 'psychologist'] },
